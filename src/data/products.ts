  ...
  },
  {
    ...
    content: {
      matte: {
        ...
        imageAlt: "Матовая моющаяся краска на стенах кухни",
        macroImage: "/img/detail-paint.png",
        macroTitle: "Почему покрытие выдерживает нагрузку",
        macroBody: "Акриловая дисперсия, микрокристаллический мраморный наполнитель и диоксид титана формируют плотную матовую плёнку. Поверхность остаётся ровной визуально, но выдерживает уборку поролоновой губкой с неабразивными моющими и дезинфицирующими средствами.",
        macroAlt: "Деталь покрытия Genesis Starke Farbe",
        title: "Матовая прочность для рабочих стен",
        body: "Starke Farbe создана для стен, которые не просто выглядят чисто, а ежедневно выдерживают прикосновения, влажную уборку и эксплуатационную нагрузку. Покрытие остаётся матовым, очень ровным и гладким, при этом допускает многократное мытьё и дезинфекцию без абразивов.",
        points: [
          "1 класс стойкости к мокрому истиранию",
          "Более 10 000 проходов щёткой по DIN 53778 Т2",
          "Матовая поверхность без брызг и потёков при нанесении",
          "Подходит для влажных и нагруженных помещений",
        ],
      },
      application: {
        roller: {
